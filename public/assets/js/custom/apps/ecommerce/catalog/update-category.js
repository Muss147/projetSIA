  ...
  return {
    init: function () {
      (i = new bootstrap.Modal(
        document.querySelector("#kt_modal_edit_categ")
      )),
        (r = document.querySelector("#kt_modal_edit_categ_form")),
        (t = r.querySelector("#kt_modal_edit_categ_submit")),
        (e = r.querySelector("#kt_modal_edit_categ_cancel")),
        (o = r.querySelector("#kt_modal_edit_categ_close")),
